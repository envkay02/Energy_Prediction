...
class SimpleNN(nn.Module):
    ...
    def __init__(self):
        ...
        # TODO: Set the number of input features (first param of fc1) based on the chosen dataset:
    ...
    def forward(self, x):
        x = torch.relu(self.fc1(x)) #ReLU activation function for the hidden layer
...
for i in range(20):
    ...
    model_NN1.eval()
    with torch.no_grad():
        test_outputs = model_NN1(X_test_tensor)
...
print("Neural Network w. 1 hidden layers:")
