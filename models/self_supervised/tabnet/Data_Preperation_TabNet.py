...
# TODO: Specify the train-test split ratio here:
...
test_features, valid_features, test_labels, valid_labels = train_test_split(
    test_features, test_labels, test_size=0.5, stratify=test_labels, random_state=42
)
